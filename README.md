...
|use.SCC|使用するSCCデザインを選択する<br>（現バージョンでは、IKASCC固定である。将来用）|
...
|date|firmware|note|
|:--|:--|:--|
|2025/09/01|mgspico3z_firmware_v3.4.0|●機能追加:<br>・VGM形式、TGF形式の楽曲データの再生に対応した。<br>(基地の門d内としてVGM/TGFのデータを再生開始時や再思中にプチノイズが混ざることあり)<br>・SDカード内のディレクトリ階層にも対応しました<br>●改善:<br>・SETTING画面の操作性を改善しました|
