...
//Created Time: 2025-04-05 06:44:37
create_clock -name i_CLK_3M072 -period 325.521 -waveform {0 162.761} [get_ports {i_CLK_3M072}]
create_clock -name clk_17M9 -period 55.866 -waveform {0 27.933} [get_pins {u_osc/osc_inst/OSCOUT}]
...
set_clock_groups -exclusive -group [get_clocks {i_CLK_3M072}] -group [get_clocks {i_CLK_3M579}] -group [get_clocks {clk_17M9}]
set_clock_groups -exclusive -group [get_clocks {clk_71M7}] -group [get_clocks {clk_17M9}]
